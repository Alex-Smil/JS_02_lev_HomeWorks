...
function validateInput(eventObj) {
        ...
        if((nameInput.value === '') || (/(^[а-яё']{1,3}$)|(^[a-z']{1,3}$)/i.test(nameInput.value))) { 
            switch(event) {
                case 'input':
                    ...
                    $(`#${nameInput.id}Dialog`).dialog('close'); // ex 2 *** les 5
                    if(nameInput.value === '') {
            ...
            // данный ретурн нужен только для тестов
            return true;
        } else { 
            ...
            switch(event) {
                case 'input':
                    ...
                    break;
                case 'change':
                    applayJQueryUI_Effect(nameInput.id); // ex 1-b *** les 5
                    $(`#${nameInput.id}Dialog`).dialog( "moveToTop" ); // ex 2 *** les 5
                    $(`#${nameInput.id}Dialog`).dialog('open'); // ex 2 les *** 5
        ...
        if((emailInput.value === '') || (/^[\w-']+@[a-z]+\.[a-z]+(\.[a-z]+)?$/i.test(emailInput.value))) {
            switch(event) {
                case 'input':
                    ...
                    $(`#${emailInput.id}Dialog`).dialog('close'); // ex 2 *** les 5
                    if(emailInput.value === '') {
            ...
            switch(event) {
                case 'input':
                    ...
                    break;
                case 'change':
                    applayJQueryUI_Effect(emailInput.id); // ex 1-b *** les 5
                    $(`#${emailInput.id}Dialog`).dialog('open'); // ex 2 *** les 5
                    break;
            }
            // данный ретурн нужен только для тестов
            return false;
        ...
        if((telInput.value === '') || (/^\+\d\(\d{3}\)\d{3}-\d{4}$/.test(telInput.value))) {
            switch(event) {
                case 'input':
                    ...
                    $(`#${telInput.id}Dialog`).dialog('close'); // ex 2 *** les 5
                    if(telInput.value === '') {
            ...
            switch(event) {
                ...
                case 'change':
                    applayJQueryUI_Effect(telInput.id); // ex 1-b *** les 5
                    $(`#${telInput.id}Dialog`).dialog('open'); // ex 2 *** les 5
                    break;
            }
            // данный ретурн нужен только для тестов
            return false;
        ...
        if(/^.{0,5}$/i.test(textArea.value)) {
            switch(event) {
                case 'input':
                    ...
                    $(`#${textArea.id}Dialog`).dialog('close'); // ex 2 *** les 5
                    if(textArea.value === '') {
            ...
            switch(event) {
                ...
                case 'change':
                    applayJQueryUI_Effect(textArea.id); // ex 1-b *** les 5
                    $(`#${textArea.id}Dialog`).dialog('open'); // ex 2 *** les 5
                    break;
            }
            // данный ретурн нужен только для тестов
            return false;
    ...
    function applayJQueryUI_Effect(inputId) { // ex 1-b *** les 5
